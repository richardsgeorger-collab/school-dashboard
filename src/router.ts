...
export type Route = 'now' | 'calendar' | 'plan' | 'load' | 'library' | 'grades' | 'settings' | 'quiz' | 'class' | 'ingest' | 'tutor' | 'study' | 'news';
const ROUTES: Route[] = ['now', 'calendar', 'plan', 'load', 'library', 'grades', 'settings', 'quiz', 'class', 'ingest', 'tutor', 'study', 'news'];
