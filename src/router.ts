...
export type Route = 'now' | 'calendar' | 'plan' | 'load' | 'record' | 'grades' | 'settings';
const ROUTES: Route[] = ['now', 'calendar', 'plan', 'load', 'record', 'grades', 'settings'];
const ALIASES: Record<string, Route> = { home: 'now', '': 'now' };
