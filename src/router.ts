...
export type Route = 'now' | 'calendar' | 'plan' | 'load' | 'library' | 'grades' | 'settings' | 'quiz' | 'class';
const ROUTES: Route[] = ['now', 'calendar', 'plan', 'load', 'library', 'grades', 'settings', 'quiz', 'class'];
